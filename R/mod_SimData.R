           ...
           sidebarLayout(
             sidebarPanel(style="height: 500px;",
                  ...
                  fluidRow(
                    ...
                    bsPopover(id=ns("te2"),title="<strong>Treatment Effect</strong>",
                              content=te.txt,
                              "right",options = list(container = "body"))),
                  fluidRow(column(12,
                  ...
                  fluidRow(
                    ...
                    bsPopover(id=ns("range"),title="<strong>Range</strong>",
                              content=range.txt,
                              "right",options = list(container = "body"))),
                  ...
                  fluidRow(strong("Group Overlap"),
                           ...
                           bsPopover(id=ns("overlap"),title="<strong>Group Overlap</strong>",
                                     content=overlap.txt,
                                     "right",options = list(container = "body"))),
           ...
           sidebarLayout(
             sidebarPanel(style="height: 700px;",#width=6,
              ...
              fluidRow(column(12,
                              ...
                              bsPopover(id=ns("te3"),title="<strong>Treatment Effect</strong>",
                                        content=te.txt ,
                                        "right",options = list(container = "body")))
              ),
              ...
              fluidRow(
                ...
                bsPopover(id=ns("rho"),title="<strong>Covariate Correlation</strong>",
                          content=rho.txt ,
                          "right",options = list(container = "body"))),
              ...
              fluidRow(
                ...
                bsPopover(id=ns("xy"), title=NULL, content=xy.txt,
                          "right", options = list(container = "body"))),
