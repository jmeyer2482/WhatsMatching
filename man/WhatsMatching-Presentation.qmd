...
-   I'll just quickly give you some context for what you are seeing and then I'll do a demonstration of the actual app
:::
...
-   This particular simulation is based on one by King and Neilsen which was looking at the propensity score paradox.
...
::: notes
-   These are some questions we think can be given insights to by using the app
-   Having invested a significant amount of time in understanding the matching process I think I can safely say that an intuitive understanding of matching begins and ends with the fact that units are being paired
:::
