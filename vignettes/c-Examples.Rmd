...
<div style="display: block; border: 1px solid #3a3b3c; background-color:#f7f7f7; color:#3a3b3c; margin:20pt; padding:10pt">

  <div style="font-size:2em; float: left; margin-right: 1em;">
  
  <a href='https://jmeyer2482.shinyapps.io/WhatsMatching/' target="_blank">
    <img style="border:2px solid #3a3b3c; width: 1cm;" src="../man/figures/logo.png" />
  </a>
  
  </div>

<div style="display:block; margin-left: 3em;">
...
* Click Use the data from Simulation 1
* Use the default matching settings, comparing Mahalanobis-based distance matching to propensity score-based distance matching
* Press play
</div>
...
<table style="border: none; text-align: center;">
  ...
  <tr>
  	  <td colspan="3"><img src="../man/figures/Ex-Forgotten-confounder.PNG" border=0 width="100%"> </img></td>
  </tr>
</table>
```
...
### A bit of a summary of some main limitations
